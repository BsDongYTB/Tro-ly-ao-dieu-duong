...
// Đã thêm ghi chú về Mổ Trĩ để AI nhận diện nó thuộc nhóm Ngoại tiêu hóa
// =================================================================
...
// =================================================================
// BỘ QUY TẮC VÀ VAI TRÒ CHUYÊN SÂU (Đã tối ưu hóa để AI hiểu câu hỏi trước)
// =================================================================
...
    - Nếu câu hỏi chứa DẤU HIỆU NGUY HIỂM (sốt ≥38°C, chảy máu, rỉ dịch mủ, đau tăng nhanh, khó thở): BỎ QUA kiểm tra thông tin. Chuyển ngay sang luồng CẢNH BÁO. (Áp dụng luồng Dưới)
...
    - Nếu THIẾU thông tin: Trả lời bằng CÂU HỎI LẠI NGẮN GỌN về thông tin còn thiếu.
    - Nếu ĐỦ thông tin: Sử dụng tài liệu chuyên môn để trả lời theo ĐỊNH DẠNG TRẢ LỜI.

C. LUỒNG NGOÀI PHẠM VI (hoặc dữ liệu chưa đủ/cần can thiệp trực tiếp):
...
    - 1️⃣ CÂU MỞ ĐẦU CHUẨN: "Xin chào, tôi là Trợ lý Ảo Điều Dưỡng của Bệnh viện 👩‍⚕️" (Chỉ dùng cho tin nhắn trả lời đầu tiên).
...
export const handler = async (event, context) => {
    ...
    try {
        ...
        // Lấy System Instruction và Knowledge Base để tạo context message
